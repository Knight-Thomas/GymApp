//
//  GymHexWorkoutTrackerImages.swift
//  GymHexSwiftUI
//
//  Created by Tom Knight on 07/06/2024.
//
import SwiftUI

struct GymHexWorkoutTrackerImages: View {
    private var colorsArr: [Image] = [FlatDBBench, InclineDBBench, DeclineDBBench, FlatBBBench, .orange, .accentColor, .cyan, .brown, .indigo]
...
struct GymHexWorkoutTrackerImages_Previews: PreviewProvider {
